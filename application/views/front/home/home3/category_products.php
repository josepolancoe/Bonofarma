    ...
    <div class="container">
        <div class="row mx-0 d-lg-flex">
        	<div class="col-md-3 px-0">
        		<div class="home-3-category d-flex align-items-center h-100" style="background-image: url('<?php echo $this->crud_model->file_view('category',$row['category'],'','','no','src','',''); ?>'); background-repeat: no-repeat; background-position: center">
        			<div>
