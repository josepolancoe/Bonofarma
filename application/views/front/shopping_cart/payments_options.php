...
<div class="row">
    ...
    <div class="cc-selector col-sm-3">
        ...
        <label class="drinkcard-cc" style="margin-bottom:0px; width:100%; overflow:hidden; " for="mastercard" onclick="radio_check('mastercard')">
            <img src="<?php echo base_url(); ?>template/front/img/preview/payments/contraentrega.png" width="100%" height="100%" style=" text-align-last:center;" alt="<?php echo translate('cash_on_delivery');?>" />
               <!-- IMAGEN PAGO CONTRAENTREGA -->
        </label>
    </div>
    <?php 
            }
